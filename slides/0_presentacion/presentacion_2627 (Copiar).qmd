...
subtitle: Presentación curso 2026/27
author:
...
format:
  clean-revealjs:
    width: 1920
    height: 1080
    footer: "Técnicas avanzadas de predicción - Curso 2026-27"
    echo: true
    incremental: false
    scrollable: true
    code-overflow: wrap
...
| 15 | Evaluación | Defensa oral del proyecto |
:::
:::::
::::: {.column width="2.5%"}
:::::
...
## Trabajo en las prácticas {style="color:#447099"}
...
## Proyecto del cuatrimestre {style="color:#447099"}
...
- **Semana 10:** revisión intermedia con retroalimentación.
...
::: {.callout-important title="Defensa oral: semana 15"}
Todos los miembros deben estar presentes y participar. Reservad la fecha cuando se publique en el Aula Virtual.
:::
:::::
::::::

## Hitos del proyecto {style="color:#447099"}
...
| 8 | Ensambles |
| 9 | SVM y comparación con los modelos anteriores |
| 10 | Revisión intermedia y retroalimentación |
| 13 | Extensión causal opcional |
| 15 | Entrega final y defensa oral |
:::
...
## Rúbrica del proyecto (sintética) {style="color:#447099"}
...
|:--|:--|:--:|
| **Formulación y datos** | Pregunta de negocio, elección de datos y análisis exploratorio | **10 %** |
| **Proyecto reproducible** | Repositorio, entorno y ejecución del análisis sin fugas de información | **15%** |
...
De los 7 hitos previos a la entrega final (semanas 2, 4, 6, 8, 9, 10 y 13), cada hito no completado reduce la nota global del proyecto según:

$$
\text{factor} = 0.5 + 0.5 \times \frac{\text{hitos completados}}{7}
$$
...
## Uso de IA y registro {style="color:#447099"}
...
- Nombrad cada archivo exportado como `fecha_integrante_herramienta` (por ejemplo, `2026-10-03_ana_chatgpt.md`). La conversación es la evidencia; lo demás se contrasta con la memoria, el notebook y en la defensa.
